...
def calculate_room_occupancy(occupancy_file, start_date_str, end_date_str):
    """
    Calculates room occupancy statistics from a CSV file.
    ...
    return total_room_nights, occupied_room_nights
...
if __name__ == "__main__":
    ...
    total_room_nights, occupied_room_nights = calculate_room_occupancy(occupancy_file_path, start_date, end_date)
